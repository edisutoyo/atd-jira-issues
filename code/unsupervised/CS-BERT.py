...
# List of keywords
# ---------------------------------------
keywords = ['move', 'refactor', 'remove', 'dependency', 'couple', 'update', 'improve', 'relocate', 'transfer', 'migrate', 'problem', 'increase', 'extend', 'depend', 'change']

# N-gram setting
n_gram = 1

# Define a set of excluded words (all lowercase if you are lowercasing text)
excluded_words = {}
